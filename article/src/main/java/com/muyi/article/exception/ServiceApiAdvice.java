...
import com.muyi.model.ErrorDetails;
import com.muyi.model.Response;
import com.muyi.model.exception.BadCredentialsException;
...
@ControllerAdvice(annotations = RestController.class, basePackages = "com.muyi.article.controller")
@ResponseBody
